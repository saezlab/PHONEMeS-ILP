...
experiments <- list(cond1=c("rapa - ins"))
...
# pknList@interactions <- rbind(pknList@interactions, c("Q92769", "HDAC2_HUMAN", "P67870", "CSK2B_HUMAN", "S", "516", "e999", "HDAC2_HUMAN.S.516", 1))
show(pknList)
