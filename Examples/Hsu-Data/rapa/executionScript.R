...
experiments <- c(1) # for rapa -- experiment <- c(2) for tor
...
write.table(x = resultsMulti, file = "rapa_sif_cplex.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
...
write.table(x = resultsSampling, file = "rapa_sif_downsampling.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
write.table(x = resultsSampling[which(resultsSampling[, 2]>=10), ], file = "rapa_sif_downsampling_cutoff10.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
