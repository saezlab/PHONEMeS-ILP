...
runPHONEMeS_Signed <- function(targets.S, targets.I, conditions, dataGMM, experiments, bg, nK="all", solver="cplex"){
...
write_lp_file <- function(dataGMM, pknList, targets.S, targets.I, targets.P, experiments){
  ...
  binary_orin_orout <- create_orin_orout_variables(dataMatrix = dataMatrix, targets = targets.P)
