##
buildDataMatrix2 <- function(dataMatrix = dataMatrix, sif = sif, targets = targets, experiments = experiments){
...
##
create_binary_variables_for_y_vector_step_2 <- function(sif = resultsSIF){
...
##
write_one_edge_constraint <- function(sif = resultsSIF, dataMatrix = dataMatrix, binaries = binaries){
...
##
write_intermediate_node_constraints_out <- function(sif = resultsSIF, dataMatrix = dataMatrix, binaries = binaries){
...
##
write_intermediate_node_constraints_in <- function(sif = resultsSIF, dataMatrix = dataMatrix, binaries = binaries){
...
##
write_reaction_constraints <- function(dataMatrix = dataMatrix, sif = resultsSIF, binaries = binaries){
