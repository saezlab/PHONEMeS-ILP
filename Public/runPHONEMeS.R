...
runPHONEMeS <- function(targets.P, conditions, dataGMM, experiments, bg, nK="all", solver="cplex", nSolutions=100, mipgap=0, relgap=0, replace=2, populate=5000, intensity=4, timelimit=3600){
...
write_lp_file <- function(dataGMM, pknList, targets, experiments, nSolutions, mipgap, relgap, replace, populate, intensity, timelimit){
